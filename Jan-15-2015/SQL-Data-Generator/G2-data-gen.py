...
limitedStopTime = datetime.time(hour=16, minute=30);
minPeriod = datetime.timedelta(hours=8);
maxPeriod = datetime.timedelta(hours=8);
...
pf = 0.7; #Actually it's not constant like this, just assume for the sake of simplicity
updateAt = "null";
modBy = "null";
desc = "null";
power = 0;
