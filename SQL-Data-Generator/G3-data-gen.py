...
powerMin = 0;
powerMax = 10;
limitedStartTime = datetime.time(hour=8, minute=30);
limitedStopTime = datetime.time(hour=18, minute=0);
minPeriod = datetime.timedelta(hours=1);
maxPeriod = datetime.timedelta(hours=1);
...
pf = 0.5; #Actually it's not constant like this, just assume for the sake of simplicity
updateAt = "null";
modBy = "null";
desc = "null";
power = 0;
...
pwtg = PowerWithTimeGenerator(limitedStartTime, limitedStopTime, minPeriod, maxPeriod, minSecondInterval, maxSecondInterval, startDate, endDate, powerMin, powerMax);
