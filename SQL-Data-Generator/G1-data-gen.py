...
powerList = [0, 126, 200, 326];
limitedStartTime = datetime.time(hour=9, minute=0);
limitedStopTime = datetime.time(hour=16, minute=0);
...
pf = 0.6; #Actually it's not constant like this, just assume for the sake of simplicity
updateAt = "null";
modBy = "null";
desc = "null";
power = 0;
